...
import { Box, Button, createTheme, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, IconButton, InputLabel, MenuItem, outlinedInputClasses, Paper, Select, styled, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Theme, ThemeProvider , useTheme } from '@mui/material'
...
export default function GestionVente() {
  ...
  const handleCloseModif = () => {
    ...
    function createData(
      ...
      return { titre, quantite, category, prix , image, vendeur,date};
    }
  ...
  return (
    ...
    <div className='flex justify-around align-items-center  gap-3 mt-5'>
        <div><Button onClick={handleClickOpen} className='' style={{backgroundColor:'#fe5300', color:'#fff',border:'none'}}><FontAwesomeIcon icon={faPlus} className='text-white me-2' style={{fontSize:'20px'}} />Ajouter une vente</Button></div>
